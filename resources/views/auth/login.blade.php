    ...
    <div class="w-full max-w-md">
        <div class="bg-white rounded-2xl shadow-lg p-8">
            ...
            <div class="text-center mb-6">
                ...
                <p class="text-gray-500 text-sm mt-2 leading-relaxed">Welcome back! Monitor your child's growth and health journey with ease.</p>
            </div>
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <!-- Email Field -->
                <div class="mb-4">
                    <label class="block text-xs font-semibold text-gray-600 uppercase tracking-wider mb-1.5">Username / Email</label>
                    <div class="relative">
