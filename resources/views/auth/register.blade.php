    ...
    <div class="w-full max-w-md">
        <div class="bg-white rounded-2xl shadow-lg p-8">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="mb-4">
                    <label
                        class="block text-xs font-semibold text-gray-600 uppercase tracking-wider mb-1.5">Username</label>
                    <div class="relative">
                ...
                <div class="mb-4">
                    <label
                        class="block text-xs font-semibold text-gray-600 uppercase tracking-wider mb-1.5">Email</label>
                    <div class="relative">
                        <span class="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <!-- Confirm Password -->
                <div class="mb-4">
                    <label class="block text-xs font-semibold text-gray-600 uppercase tracking-wider mb-1.5">Konfirmasi
                        Password</label>
                    <div class="relative">
                        <span class="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="mb-6">
                    <label class="flex items-start gap-2 cursor-pointer">
                        <input type="checkbox" name="terms"
                            class="rounded border-gray-300 text-accent focus:ring-accent mt-0.5" required>
                        <span class="text-sm text-gray-600">
                            Saya menyetujui <a href="#" class="text-accent hover:underline font-medium">Syarat &
                                Ketentuan</a> serta <a href="#"
                                class="text-accent hover:underline font-medium">Kebijakan Privasi</a>.
                        </span>
                    </label>
                    @error('terms')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
            ...
            <!-- Google Sign Up -->
            <button type="button"
                class="w-full py-3 border border-gray-200 rounded-full text-sm font-medium text-gray-600 hover:bg-gray-50 transition flex items-center justify-center gap-3">
            ...
            <p class="text-center text-sm text-gray-500 mt-6">
                Sudah punya akun? <a href="{{ route('login') }}" class="text-accent hover:underline font-medium">Masuk
                    di sini</a>
            </p>
        </div>
    </div>
