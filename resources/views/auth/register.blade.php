...
<head>
    ...
    <title>Daftar - GoKids</title>
    <meta name="description" content="Daftar akun GoKids - Platform pemantauan tumbuh kembang dan kesehatan anak">
    ...
    <div class="w-full max-w-md">
        <div class="bg-white rounded-2xl shadow-lg p-8">
            ...
            <div class="text-center mb-6">
                <div class="w-16 h-16 bg-accent rounded-full flex items-center justify-center mx-auto mb-3 shadow-md">
                    <svg class="w-9 h-9 text-white" viewBox="0 0 24 24" fill="currentColor">
                        <circle cx="12" cy="9" r="3.5"/>
                        <path d="M12 14c-4.5 0-7 2.5-7 4.5V20h14v-1.5c0-2-2.5-4.5-7-4.5z"/>
                        <circle cx="7.5" cy="6.5" r="1" opacity="0.5"/>
                        <circle cx="16.5" cy="6.5" r="1" opacity="0.5"/>
                    </svg>
                </div>
                <h1 class="text-3xl font-bold text-gray-800">GoKids</h1>
                <p class="text-gray-500 text-sm mt-2 leading-relaxed">Daftar sekarang untuk mulai memantau tumbuh kembang anak Anda.</p>
            </div>
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <!-- Confirm Password -->
                <div class="mb-4">
                    <label class="block text-xs font-semibold text-gray-600 uppercase tracking-wider mb-1.5">Konfirmasi Password</label>
                    <div class="relative">
                        <span class="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400">
                ...
                <div class="mb-6">
                    <label class="flex items-start gap-2 cursor-pointer">
                        <input type="checkbox" name="terms" class="rounded border-gray-300 text-accent focus:ring-accent mt-0.5" required>
                        <span class="text-sm text-gray-600">
                            Saya menyetujui <a href="#" class="text-accent hover:underline font-medium">Syarat & Ketentuan</a> serta <a href="#" class="text-accent hover:underline font-medium">Kebijakan Privasi</a>.
                        </span>
                    </label>
                    @error('terms')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
            ...
            <div class="flex items-center my-6">
                ...
                <span class="px-4 text-xs text-gray-400 font-semibold uppercase">Atau</span>
                <div class="flex-1 border-t border-gray-200"></div>
            </div>

            <!-- Google Sign Up -->
            <button type="button" class="w-full py-3 border border-gray-200 rounded-full text-sm font-medium text-gray-600 hover:bg-gray-50 transition flex items-center justify-center gap-3">
            ...
            <p class="text-center text-sm text-gray-500 mt-6">
                Sudah punya akun? <a href="{{ route('login') }}" class="text-accent hover:underline font-medium">Masuk di sini</a>
            </p>
        </div>
    </div>
</body>
