    ...
    <div class="flex min-h-screen">
        ...
        <aside class="fixed left-0 top-0 h-full w-[220px] bg-primary text-white flex flex-col z-50 shadow-xl">
            ...
            <nav class="flex-1 px-3 py-4 space-y-1">
                <a href="/dashboard" class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium {{ request()->is('dashboard') ? 'active' : '' }}">
                    <span class="text-lg">📊</span>
                    <span>Dashboard</span>
                </a>
                <a href="/input" class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium {{ request()->is('input*') ? 'active' : '' }}">
                    <span class="text-lg">➕</span>
                    <span>Input</span>
                </a>
                <a href="/profil" class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium {{ request()->is('profil*') ? 'active' : '' }}">
                    <span class="text-lg">👤</span>
                    <span>Profil</span>
                </a>
            </nav>
